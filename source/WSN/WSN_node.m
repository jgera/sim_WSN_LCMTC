classdef WSN_node < node
    ...
    properties
        ...
        % usa un modello di propagazione indoor empirico: C:\Users\Luca\GoogleDrive_LB\Universita\CAES_2\EH_LSA\papers\attenuazione
        % per calcolare l'attenuazione del segnale al nodo poi calcola il
        % numero di pacchetti persi a causa dell'elevata attenuazione.
    end
    
    methods
        %% The constructor of the WSN_node
        function obj = WSN_node(type,daily_tx,resolution,simulation_length)
